...
namespace TReport.TREntities
{
    ...
    public class TREnergy1 : TR
    {
        ...
        public TREnergy1(trObj trObj) : base(trObj) { }

        public TREnergy1(trObj[] trObjs) : base(trObjs) { }

        public TREnergy1(List<trObj> trObjs) : base(trObjs) { }
        ...
        public EnergySutkiObject GetEnergySutkiObject(DateTime date, trObj trobj)
        {
            ...
            object ies = null;// data.GetEnergySutkiObject(date, trobj);
